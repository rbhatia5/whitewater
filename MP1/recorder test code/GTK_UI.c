...
static void create_ui()
{
	...
	GtkWidget *main_hbox;
	GtkWidget *controls;
	GtkWidget *record_button, *play_button, *pause_button, *stop_button;
	...
	record_button = gtk_button_new_from_stock(GTK_STOCK_MEDIA_RECORD);
	g_signal_connect(record_button, "clicked", G_CALLBACK(record_cb), NULL);
